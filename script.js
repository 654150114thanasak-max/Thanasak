...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const pages = {
        ...
        port2: `<div class="fade-in"><p class="greeting">CEFR</p><div class="port-grid"><div class="port-item"><img src="work6.jpg" alt="เกียรติบัตร CEFR 1"><p>เกียรติบัตร CEFR 1</p></div><div class="port-item"><img src="images/work7.jpg" alt="เกียรติบัตร CEFR 2"><p>เกียรติบัตร CEFR 2</p></div></div></div>`,
        ...
        port4: `<div class="fade-in"><p class="greeting">วุฒิทางลูกเสือ</p><div class="port-grid"><div class="port-item"><img src="work11.jpg" alt="เกียรติบัตรลูกเสือ 1"><p>เกียรติบัตรลูกเสือ 1</p></div><div class="port-item"><img src="images/work12.jpg" alt="เกียรติบัตรลูกเสือ 2"><p>เกียรติบัตรลูกเสือ 2</p></div></div></div>`,
